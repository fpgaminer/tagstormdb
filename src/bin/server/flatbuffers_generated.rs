...
impl<'a> Image<'a> {
  ...
  pub fn tags(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TagWithBlame<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TagWithBlame>>>>(Image::VT_TAGS, None)}
  }
  #[inline]
  pub fn attributes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AttributeWithBlame<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AttributeWithBlame>>>>(Image::VT_ATTRIBUTES, None)}
  }
}
...
impl flatbuffers::Verifiable for Image<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<AttributeWithBlame>>>>("attributes", Self::VT_ATTRIBUTES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> ImageResponse<'a> {
  ...
  pub fn images(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Image<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Image>>>>(ImageResponse::VT_IMAGES, None)}
  }
}
...
impl<'a> IDResponse<'a> {
  ...
  pub fn ids(&self) -> Option<flatbuffers::Vector<'a, u32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(IDResponse::VT_IDS, None)}
  }
}
...
impl<'a> HashResponse<'a> {
  ...
  pub fn hashes(&self) -> Option<flatbuffers::Vector<'a, Hash>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Hash>>>(HashResponse::VT_HASHES, None)}
  }
}
...
impl<'a> SearchResultResponse<'a> {
  ...
  pub fn data_type(&self) -> ResponseType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ResponseType>(SearchResultResponse::VT_DATA_TYPE, Some(ResponseType::NONE)).unwrap()}
  }
  #[inline]
  pub fn data(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(SearchResultResponse::VT_DATA, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for SearchResultResponse<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<ResponseType, _>("data_type", Self::VT_DATA_TYPE, "data", Self::VT_DATA, false, |key, v, pos| {
        match key {
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SearchResultResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_data_type(&mut self, data_type: ResponseType) {
    self.fbb_.push_slot::<ResponseType>(SearchResultResponse::VT_DATA_TYPE, data_type, ResponseType::NONE);
  }
  #[inline]
...
#[inline]
pub fn finish_size_prefixed_search_result_response_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<SearchResultResponse<'a>>) {
